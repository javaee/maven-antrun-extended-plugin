 ...
 * @author Paul Sterk
 */
public final class ExcludeArtifactsFilter extends GraphFilter implements GraphVisitor {
    /**
    ...
    public ExcludeArtifactsFilter(Collection<String> artifactIds) throws IOException {
        for (String artifactId : artifactIds)
            addArtifactId(artifactId);
    }

    public ExcludeArtifactsFilter(String... artifactIds) throws IOException {
        this(Arrays.asList(artifactIds));
    }

    public ExcludeArtifactsFilter(String artifactId) throws IOException {
        addArtifactId(artifactId);
    }
